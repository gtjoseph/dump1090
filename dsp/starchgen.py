...
gen.add_function(name = 'boxcar_u16', argtypes = ['const uint16_t *', 'unsigned', 'unsigned', 'uint16_t *'], aligned = True)
gen.add_function(name = 'preamble_u16', argtypes = ['const uint16_t *', 'unsigned', 'unsigned', 'uint16_t *'], aligned = True)
